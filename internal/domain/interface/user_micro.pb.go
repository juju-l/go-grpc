...
type UserGrpcService interface {
	Login(ctx context.Context, in *pb.User, opts ...client.CallOption) (*pb.UserResult, error)
}
...
func (c *userGrpcService) Login(ctx context.Context, in *pb.User, opts ...client.CallOption) (*pb.UserResult, error) {
...
func RegisterUserGrpcHandler(s server.Server, hdlr UserGrpcHandler, opts ...server.HandlerOption) error {
	type userGrpc interface {
		Login(ctx context.Context, in *pb.User, out *pb.UserResult) error
	}
...
func (h *userGrpcHandler) Login(ctx context.Context, in *pb.User, out *pb.UserResult) error {
