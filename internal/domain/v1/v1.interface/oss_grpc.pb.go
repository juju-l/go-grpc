...
type OssGrpcClient interface {
	Test(ctx context.Context, in *v1_proto.Oss, opts ...grpc.CallOption) (*v1_proto.OssResult, error)
}
...
func (c *ossGrpcClient) Test(ctx context.Context, in *v1_proto.Oss, opts ...grpc.CallOption) (*v1_proto.OssResult, error) {
...
func _OssGrpc_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OssGrpcServer).Test(ctx, req.(*v1_proto.Oss))
	}
