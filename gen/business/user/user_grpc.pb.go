...
type UserGrpcClient interface {
	Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*pb.BaseResult, error)
}
...
func (c *userGrpcClient) Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*pb.BaseResult, error) {
	out := new(pb.BaseResult)
	err := c.cc.Invoke(ctx, "/proto.UserGrpc/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserGrpcServer interface {
	Login(context.Context, *User) (*pb.BaseResult, error)
...
func (UnimplementedUserGrpcServer) Login(context.Context, *User) (*pb.BaseResult, error) {
...
func _UserGrpc_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UserGrpc/Login",
	}
